...
st.write("In this WebApp you will be able to observe your predicted calories burned in your body. Pass your values such as `Age`, `Gender`, `BMI`, etc., into this WebApp and then you will see the predicted value of kilocalories burned and the comparison between other persons to you.")
...
def user_input_features():
    ...
    heart_rate = st.sidebar.slider("Heart Rate(per min): ", 60, 130, 80)
    ...
    activity_mapping = {"Sedentary": 1, "Lightly Active": 2, "Moderately Active": 3, "Very Active": 4}
